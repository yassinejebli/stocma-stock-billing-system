    ...
    <>
      ...
      {paiementModule?.Enabled && (
        <>
          {canManagePaiementsFournisseurs && (
            <Route
              path="/liste-paiements-des-fournisseurs"
              component={
                useVAT
                  ? PaiementFactureFournisseurList
                  : PaiementFournisseurList
              }
            />
          )}
          {canManagePaiementsClients && (
            <Route
              path="/liste-paiements-des-clients"
              component={
                useVAT ? PaiementClientFactureList : PaiementClientList
              }
            />
          )}
          {canManagePaiementsClients && (
            <Route
              path="/liste-cheques-et-effets-des-clients"
              component={BankPaiementsClientList}
            />
          )}
          {canManagePaiementsFournisseurs && (
            <Route
              path="/liste-cheques-et-effets-des-fournisseurs"
              component={BankPaiementsFournisseurList}
            />
          )}
        </>
      )}
      ...
      {suiviModule?.Enabled && canViewSuiviAchats && (
      ...
      {mouvementModule?.Enabled && (
        <>
          ...
          {canManageMouvements && (
            <Route
              path="/liste-mouvement-stock"
              component={StockMouvementList}
            />
          )}
        </>
      )}
      ...
      {isAdmin && articlesNotSellingModule?.Enabled && (
        <Route path="/articles-non-vendus" component={ArticlesNotSellingList} />
      )}
      {isAdmin && clientMarginModule?.Enabled && (
        <Route path="/marge-clients" component={ClientsMarginList} />
      )}
      {clientLoyaltyModule?.Enabled && (
        <Route path="/clients-non-fidèles" component={ClientsNotBuyingList} />
      )}
      ...
      {isAdmin && paiementModule?.Enabled && (
        <Route
          path="/liste-methodes-de-paiement"
          component={TypePaiementList}
        />
      )}
      {canManageArticles && (
        <Route path="/liste-des-familles" component={ArticleCategoriesList} />
      )}
    </>
  );
};
