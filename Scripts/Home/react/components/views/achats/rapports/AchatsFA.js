...
import PrintRapportAchatsFA from "../../../elements/dialogs/documents-print/PrintRapportAchatsFA";
...
const AchatsFA = () => {
  ...
  return (
    <ExpansionPanel title="Rapport des achats (FA)">
      <DatePicker
        value={dateFrom}
        label="Date de début"
        onChange={(date) => {
