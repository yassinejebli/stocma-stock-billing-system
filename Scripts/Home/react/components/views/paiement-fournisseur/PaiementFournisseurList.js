...
import { getPaiementFournisseurListColumns } from '../../elements/table/columns/paiementFournisseurColumns';
...
const PaiementFournisseurList = () => {
    ...
    const [showBRModal, hideBRModal] = useModal(({ in: open, onExited }) => {
        return (
            <PrintBR
                onExited={onExited}
                open={open}
...
export default PaiementFournisseurList;
