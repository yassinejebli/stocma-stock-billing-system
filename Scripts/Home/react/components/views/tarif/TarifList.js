...
import { tarifListColumns } from '../../elements/table/columns/tarifColumns'
import AddIcon from '@material-ui/icons/Add';

const DOCUMENT = 'Tarifs'
const EXPAND = ['TarifItems']
...
const TarifList = () => {
    ...
    const convertToBR = React.useCallback((id) => {
        history.push('/BonReception?TarifId=' + id);
    }, [])
        ...
        <>
            ...
            <Paper>
                <Box display="flex" justifyContent="space-between" alignItems="center">
                    <TitleIcon noBorder title="Liste des tarifs" Icon={DescriptionOutlinedIcon} />
                    <TextField
                        value={searchText}
