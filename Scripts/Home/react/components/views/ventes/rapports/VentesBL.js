...
import PrintRapportVentesBL from '../../../elements/dialogs/documents-print/PrintRapportVentesBL';
...
const VentesBL = () => {
    ...
    return (
        <ExpansionPanel title="Rapport des ventes (BL)">
            <DatePicker
                value={dateFrom}
                label="Date de début"
                onChange={(date) => {
