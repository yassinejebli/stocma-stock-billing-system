...
import PrintRapportTransactions from '../../../elements/dialogs/documents-print/PrintRapportTransactions';
...
const Transactions = () => {
    ...
    return (
        <ExpansionPanel title="Rapport des transactions">
            <DatePicker
                value={dateFrom}
                label="Date de début"
                onChange={(date) => {
