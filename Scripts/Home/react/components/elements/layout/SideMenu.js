...
const useStyles = makeStyles((theme) => ({
  ...
  appBar: {
    width: `calc(100% - ${(props) => (props.open ? drawerWidth : 0)}px)`,
...
const MenuItems = () => {
  ...
  const [showSettingSideMenu, hideSettingSideMenu] = useModal(
    ({ in: open, onExited }) => (
      <SettingsDialog
        open={open}
        onExited={onExited}
        onClose={hideSettingSideMenu}
      />
    )
  );
  ...
  return (
    <>
      ...
      {(canManageClients || canManageFournisseurs) && (
        <>
          <Divider className={classes.divider} />
          <List className={classes.list}>
          ...
          <List component="div" disablePadding>
            ...
            {canManageFacturesAchat && (
              <ListItem
                ...
                className={classes.nested}
                component={Link}
                to={useVAT ? "/FactureAchat" : "/_FactureAchat"}
              >
                <ListItemIcon />
                <ListItemText primary="Facture" />
              </ListItem>
            ...
            {canViewSuiviAchats && suiviModule?.Enabled && (
              <ListItem
                button
                className={classes.nested}
                component={Link}
      ...
      <Divider className={classes.divider} />
      {(canManageArticles || canManageMouvements) && (
        <>
          <List className={classes.list}>
            <ListItem
              button
              onClick={() => setOpenStockArticles(!openStockArticles)}
            >
              <ListItemIcon>
            ...
            <Collapse in={openStockArticles} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>
                ...
                {canManageMouvements && mouvementModule?.Enabled && (
      ...
      {(canManagePaiementsFournisseurs || canManagePaiementsClients) &&
              ...
              <List component="div" disablePadding>
                {canManagePaiementsClients && (
                  <ListItem
                    button
                    component={Link}
                    to="/liste-paiements-des-clients"
                  >
                    <ListItemIcon />
                    <ListItemText primary="Clients" />
                  </ListItem>
                ...
                {canManagePaiementsFournisseurs && (
                  <ListItem
                    button
                    component={Link}
                    to="/liste-paiements-des-fournisseurs"
                  >
                    <ListItemIcon />
                    <ListItemText primary="Fournisseurs" />
                  </ListItem>
      ...
      {(canManagePaiementsClients || canManagePaiementsFournisseurs) &&
        paiementModule?.Enabled && (
          <>
            <Divider className={classes.divider} />
            <List className={classes.list}>
              <ListItem
                button
                onClick={() => setOpenChequesEffets(!openChequesEffets)}
              >
                <ListItemIcon>
                  <PlaylistEdit className={classes.icon} />
                </ListItemIcon>
                ...
                <List component="div" disablePadding>
                  {canManagePaiementsClients && (
                    <ListItem
                      button
                      component={Link}
                      to="/liste-cheques-et-effets-des-clients"
                    >
                      <ListItemIcon />
                      <ListItemText primary="Clients" />
                    </ListItem>
                  ...
                  {canManagePaiementsFournisseurs && (
                    <ListItem
                      button
                      component={Link}
                      to="/liste-cheques-et-effets-des-fournisseurs"
                    >
                      <ListItemIcon />
                      <ListItemText primary="Fournisseurs" />
                    </ListItem>
      ...
      {canManageDepenses && depenseModule?.Enabled && (
        <>
          <Divider className={classes.divider} />
          <List className={classes.list}>
        ...
        <>
          ...
          <List className={classes.list}>
            <ListItem button component={Link} to="/code-barres">
              <ListItemIcon>
                <BarcodeScan className={classes.icon} />
              </ListItemIcon>
      ...
      <List className={classes.list}>
        ...
        <Collapse in={openSettings} timeout="auto" unmountOnExit>
          <List component="div" disablePadding>
            ...
            {canManageSites && siteModule?.Enabled && (
            ...
            {canManageArticles && (
              <ListItem button component={Link} to="/liste-des-familles">
                <ListItemIcon />
            ...
            {isAdmin && paiementModule?.Enabled && (
              <ListItem
                button
                component={Link}
                to="/liste-methodes-de-paiement"
              >
                <ListItemIcon />
          ...
          >
            <ListItemIcon>
              <ExitToAppIcon
                ...
                style={{ transform: "scaleX(-1)", color: "#eb5752" }}
              />
            </ListItemIcon>
