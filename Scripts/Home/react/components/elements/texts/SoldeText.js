    ...
    <div className={classes.root}>
      {date && (
        <div className={classes.flex}>
          ...
          <div className={classes.discount}>{formatMoney(soldeBeforeDate)}</div>
        </div>
      )}
      {date && (
        <div className={classes.flex}>
          <div className={classes.text}>Solde calculé</div>
          <div
            className={classes.total}
            style={{ color: solde !== calculatedSolde ? "red" : "black" }}
          >
      ...
      <div className={classes.flex}>
        <div className={classes.text}>Solde réel</div>
        <div className={classes.total}>{formatMoney(solde)}</div>
      </div>
    </div>
  );
};
