        ...
        Cell: ({ row: { original }, print, deleteRow, updateRow, disableRow, customAction, updateRow2 }) => {
            return (
                <Box display="flex" justifyContent="flex-end">
                    {original.IdFacture && <IconButton tabIndex={-1} size="small" onClick={() => print(original.Facture)}>
                        <PrintIcon />
                    </IconButton>}
                    ...
                    {original.IdFacture && <IconButton tabIndex={-1} size="small" onClick={() => updateRow2(original.IdFacture)}>
                        <Tooltip title="Modifier ce document">
                            <LaunchIcon />
                        </Tooltip>
                    </IconButton>}
                    {!original.IdFacture && !original.IdBonAvoirC && <IconButton tabIndex={-1} size="small" onClick={() => updateRow(original)}>
                        <EditOutlinedIcon />
                    </IconButton>}
                    ...
                    {!original.IdFacture && !original.IdBonAvoirC && <IconButton tabIndex={-1} size="small" onClick={() => deleteRow(original.Id)}>
